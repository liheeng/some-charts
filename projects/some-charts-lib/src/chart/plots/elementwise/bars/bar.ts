...
export class Bar extends PlotDrawableElement<Konva.Group> {
    ...
    constructor(
        ...
        this.relativeBounds = new AnimatedProperty<NumericDataRect>(
            relativeBounds,
        );
    ...
    override updateShapesForAnimationFrame(
        ...
        this.updateBarBoundingShape(
            dataTransformation.getRelativeRectLocationOnScreen(
                dataPoint,
                this.relativeBounds.displayedValue,
                visible,
                screen,
            ),
        );
    ...
    private arrangeTextWithinBar() {
        if (this.textShape) {
            ...
            let textSize = TextMeasureUtils.measureTextSize(
                this.labelFont,
                labelText,
            );
    ...
    override getBoundingRectangle(): NumericDataRect {
        return this.relativeBounds.displayedValue.addOffset(
