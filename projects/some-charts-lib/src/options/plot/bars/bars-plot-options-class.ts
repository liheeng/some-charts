 ...
 * */
export class BarsPlotOptionsClass
    extends PlotOptionsClass
    implements BarsPlotOptions
{
    ...
    constructor(barsPlotOptions: BarsPlotOptions) {
        ...
        this.drawLabelsOnBars =
            barsPlotOptions.drawLabelsOnBars ?? defaultSkin.drawLabelsOnBars!;
        this.font = barsPlotOptions.font!;
        this.foregroundColor = barsPlotOptions.foregroundColor!;
        this.labelsPrecision =
            barsPlotOptions.labelsPrecision ?? defaultSkin.labelsPrecision!;
        this.useDarkerBorder =
            barsPlotOptions.useDarkerBorder ?? defaultSkin.useDarkerBorder!;
    }
