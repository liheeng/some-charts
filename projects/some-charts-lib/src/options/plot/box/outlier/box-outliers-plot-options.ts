 ...
 */
export interface BoxOutliersPlotOptions
    extends BoxOutliersMajorOptions,
        BoxOutliersSkin {}
...
export class BoxOutliersPlotOptionsDefaults extends OptionsDefaults<
    BoxOutliersSkin,
    BoxOutliersMajorOptions,
