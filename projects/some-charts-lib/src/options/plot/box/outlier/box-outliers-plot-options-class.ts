...
} from './box-outliers-plot-options';
 ...
 */
export class BoxOutliersPlotOptionsClass
    extends PlotOptionsClass
    implements BoxOutliersPlotOptions
{
    ...
    constructor(boxOutliersPlotOptionsx: BoxOutliersPlotOptions) {
        ...
        this.markerSize =
            boxOutliersPlotOptionsx.markerSize ?? defaultSkin.markerSize!;
    }
