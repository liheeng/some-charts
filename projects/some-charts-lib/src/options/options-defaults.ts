...
export abstract class OptionsDefaults<
    SkinOptionsType extends SkinOptions,
    MajorOptionsType extends MajorOptions | undefined,
    OptionsType extends MajorOptionsType extends undefined
        ? SkinOptionsType
        : SkinOptionsType & MajorOptionsType,
> {
    protected constructor(
        protected defaultSkinConsts: Constants = ConstantsDefaults.bySkin[
            Skin.Default
        ],
        protected darkSkinConsts: Constants = ConstantsDefaults.bySkin[
            Skin.Dark
        ],
    ...
    public extendWith<DerivedOptionsType extends OptionsType>(
        options: DerivedOptionsType | undefined,
