...
export class Renderer implements IDisposable {
     ...
     */
    constructor(elementSelector: string, size: Size, options: RendererOptions) {
        ...
        backDiv
            .css('background-color', backgroundStyle)
