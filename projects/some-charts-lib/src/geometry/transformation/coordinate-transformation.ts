...
export class CoordinateTransformationStatic {
    static buildFromOptions(
        axesOptions: AxesOptions,
    ): CoordinateTransformation | undefined {
        ...
        if (horizontalAxisOptions.axisType == AxisTypes.NumericAxis) {
            let numericAxisOptions =
                horizontalAxisOptions as NumericAxisOptions;

            if (
                numericAxisOptions.scale?.scaleType ===
                NumericAxisScaleType.Logarithmic
            ) {
                let logarithmicScale =
                    numericAxisOptions.scale as NumericAxisLogarithmicScale;
                axesCoordinateTransformations.push(
                    new LogPointXTransformation(logarithmicScale.logarithmBase),
                );
            }
            ...
            if (
                ...
                let logarithmicScale =
                    numericAxisOptions.scale as NumericAxisLogarithmicScale;
                axesCoordinateTransformations.push(
                    new LogPointYTransformation(logarithmicScale.logarithmBase),
                );
            }
        }
