...
export class DataTransformation {
     ...
     * @returns {number}
     */
    public dataToScreenX(
        value: number,
        visible: Range<number>,
        screenWidth: number,
    ): number {
        return DataTransformation.dataToScreenDim(
            this.coordinateTransformation?.applyX(value) ?? value,
            visible,
            screenWidth,
        );
    }
    ...
    public dataToScreenY(
        ...
        return (
            screenHeight -
            DataTransformation.dataToScreenDim(
                this.coordinateTransformation?.applyY(value) ?? value,
                visible,
                screenHeight,
            )
        );
    ...
    private static dataToScreenDim(
        value: number,
        visible: Range<number>,
        screenDim: number,
    ): number {
        return (
            ((value - visible.min) * screenDim) / (visible.max - visible.min)
        );
    }
     ...
     * @returns {number}
     */
    public screenToDataX(
        value: number,
        visible: NumericRange,
        screenWidth: number,
    ): number {
        return (
            ((this.coordinateTransformation?.unapplyX(value) ?? value) *
                (visible.max - visible.min)) /
                screenWidth +
            visible.min
        );
    }
    ...
    public screenToDataY(
        ...
        return (
            ((screenHeight -
                (this.coordinateTransformation?.unapplyY(value) ?? value)) *
                (visible.max - visible.min)) /
                screenHeight +
            visible.min
        );
     ...
     */
    public screenRegionToDataXY(
        value: NumericPoint,
        visible: NumericDataRect,
        screenRegion: NumericDataRect,
    ): NumericPoint {
        const x = value.x;
        const y = value.y;
        ...
        const newX = this.screenToDataX(
            x - minXMinY.x,
            visible.getHorizontalRange(),
            screenRegion.getHorizontalRange().getLength(),
        );
        const newY = this.screenToDataY(
            y - minXMinY.y,
            visible.getVerticalRange(),
            screenRegion.getVerticalRange().getLength(),
        );
     ...
     */
    public screenRegionToDataForRect(
        rect: NumericDataRect,
        visible: NumericDataRect,
        screenRegion: NumericDataRect,
    ): NumericDataRect {
        ...
        const minXminYTransformed = this.screenRegionToDataXY(
            minXminY,
            visible,
            screenRegion,
        );
        const maxXMaxYTransformed = this.screenRegionToDataXY(
            maxXMaxY,
            visible,
            screenRegion,
        );
        ...
        return new NumericDataRect(
            minXminYTransformed.x,
            maxXMaxYTransformed.x,
            maxXMaxYTransformed.y,
            minXminYTransformed.y,
        );
    }
    ...
    public dataToScreenXY(
        ...
        const newX = this.dataToScreenX(
            x,
            visible.getHorizontalRange(),
            screenSize.width,
        );
        const newY = this.dataToScreenY(
            y,
            visible.getVerticalRange(),
            screenSize.height,
        );
     ...
     * @returns {NumericPoint}
     */
    public dataToScreenRegionXYwithoutYinvert(
        value: NumericPoint,
        visible: NumericDataRect,
        screenRegion: NumericDataRect,
    ): NumericPoint {
     ...
     * @returns {NumericDataRect}
     */
    public dataToScreenRegionForRect(
        rect: NumericDataRect,
        visible: NumericDataRect,
        screenRegion: NumericDataRect,
    ): NumericDataRect {
        ...
        let minXminYTransformed = this.dataToScreenRegionXY(
            minXminY,
            visible,
            screenRegion,
        );
        let maxXMaxYTransformed = this.dataToScreenRegionXY(
            maxXMaxY,
            visible,
            screenRegion,
        );
    ...
    public getRelativePointLocationOnScreen(
        origin: NumericPoint,
        relativeDataPoint: NumericPoint,
        visible: NumericDataRect,
        screen: NumericDataRect,
    ) {
        let originOnScreen = this.dataToScreenRegionXY(origin, visible, screen);

        return this.dataToScreenRegionXY(
            relativeDataPoint.scalarPlus(origin),
            visible,
            screen,
        ).scalarPlus(originOnScreen.additiveInvert());
    }

    public getRelativeXValueLocationOnScreen(
        origin: NumericPoint,
        xValue: number,
        visible: NumericDataRect,
        screen: NumericDataRect,
        ...
        return (
            this.dataToScreenRegionX(xValue + origin.x, visible, screen) -
            originOnScreen.x
        );
    }

    public getRelativeYValueLocationOnScreen(
        origin: NumericPoint,
        yValue: number,
        visible: NumericDataRect,
        screen: NumericDataRect,
        ...
        return (
            this.dataToScreenRegionY(yValue + origin.y, visible, screen) -
            originOnScreen.y
        );
    }

    public getRelativeRectLocationOnScreen(
        origin: NumericPoint,
        ...
        return this.dataToScreenRegionForRect(
            dataRect.addOffset(origin),
            visible,
            screen,
