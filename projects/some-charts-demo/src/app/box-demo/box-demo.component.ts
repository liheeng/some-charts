            ...
            [
                {
                    x: 'first',
                    y: [
                        650, 540, 700, 807, 730, 650, 740, 780, 780, 680, 800,
                        780, 720, 450, 560, 610, 800, 850,
                    ],
                },
                {
                    x: 'second',
                    y: [
                        740, 740, 740, 740, 680, 640, 640, 680, 700, 640, 620,
                        590, 620, 680, 680, 650, 600, 580,
                    ],
                },
                {
                    x: 'third',
                    y: [
                        610, 680, 660, 660, 520, 540, 410, 660, 770, 750, 660,
                        710, 630, 670, 640, 640, 650, 630,
                    ],
                },
                {
                    x: 'fourth',
                    y: [
                        10, 640, 610, 620, 600, 570, 560, 540, 550, 560, 710,
                        720, 690, 660, 640, 520, 640, 610,
                    ],
                },
            ],
            {
            ...
            dataSet.update([
                {
                    ...
                    y: [
                        ...
                        807,
                        730,
                        this.mathHelperService.getRandomInt(450, 700),
                        740,
                        this.mathHelperService.getRandomInt(450, 800),
                        780,
                        this.mathHelperService.getRandomInt(450, 800),
                        800,
                        780,
                ...
                },
                {
                    x: 'fourth',
                    y: [
                        this.mathHelperService.getRandomInt(5, 200),
                        640,
                        610,
                        this.mathHelperService.getRandomInt(350, 600),
                        600,
                        570,
                        this.mathHelperService.getRandomInt(350, 600),
                        540,
                        ...
                        710,
                        720,
                        this.mathHelperService.getRandomInt(350, 700),
                        660,
                        640,
                        520,
                        640,
